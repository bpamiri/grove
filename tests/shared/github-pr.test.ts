...
describe("ghPrView", () => {
  test("is exported and callable", async () => {
    const { ghPrView } = await import("../../src/shared/github");
...
describe("ghPrReview", () => {
  test("is exported and callable", async () => {
    const { ghPrReview } = await import("../../src/shared/github");
...
describe("ghPrClose", () => {
  test("is exported and callable", async () => {
    const { ghPrClose } = await import("../../src/shared/github");
...
describe("ghPrCheckout", () => {
  test("is exported and callable", async () => {
    const { ghPrCheckout } = await import("../../src/shared/github");
